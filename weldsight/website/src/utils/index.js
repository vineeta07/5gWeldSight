...
// Videos
export const weldsightHeroVideo = asset("videosweldsight/hero0.mp4");
export const highlightFirstVideo = asset("videosweldsight/highlight1.mp4");
export const highlightSecondVideo = asset("videosweldsight/highlight2.mp4");
export const highlightThirdVideo = asset("videosweldsight/highlight3.mp4");
export const highlightFourthVideo = asset("videosweldsight/highlight4.mp4");
