      ...
      <div className="fixed inset-0 flex items-center justify-center bg-white">
        <div className="text-center space-y-3">
          <div className="w-10 h-10 border-2 border-emerald-500 mx-auto flex items-center justify-center rounded bg-emerald-50 animate-pulse">
            <span className="text-emerald-600 font-mono text-sm font-bold">WS</span>
          </div>
          <div className="font-mono text-xs text-emerald-700 animate-pulse font-bold">Loading…</div>
        </div>
      </div>
    );
  }
