    ...
    <AuthLayout>
      <div className="animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-mono text-slate-600 mb-1.5 font-bold">Email address</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-xs font-mono text-slate-600 mb-1.5 font-bold">Password</label>
            <input
              type="password"
              value={password}
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-xs font-mono text-blue-600 hover:text-blue-500 transition-colors font-medium">
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 font-bold text-sm text-white rounded transition-all disabled:opacity-50 hover:shadow-lg"
        ...
        <div className="mt-6 text-center">
          ...
          <Link to="/signup" className="text-blue-600 text-xs font-mono hover:text-blue-500 transition-colors font-bold">Create Account</Link>
        </div>

        <div className="mt-4 pt-4 border-t border-slate-200">
          <button
            onClick={handleDemo}
            className="w-full py-2.5 text-xs font-mono text-blue-700 border border-blue-300 hover:border-blue-400 hover:bg-blue-50 transition-all rounded bg-blue-50/50 font-bold"
          >
