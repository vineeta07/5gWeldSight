  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="font-display font-bold text-2xl text-slate-900 tracking-wide">Analytics</h1>
        </div>
        <Link to="/reports" className="px-4 py-2 border border-slate-300 text-slate-700 hover:bg-slate-50 text-sm font-medium rounded transition-colors flex items-center gap-2 font-mono">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>View reports</Link>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <div className="glass-panel p-4">
          <div className="font-mono text-xs text-cyan-600 font-medium mb-4">Findings over the last 24 hours</div>
        ...
        {/* Threats by camera */}
        <div className="glass-panel p-4">
          <div className="font-mono text-xs text-cyan-600 font-medium mb-4">Findings by camera</div>
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={cameraData} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
              ...
              <YAxis tick={{ fill: "#475569", fontSize: 10, fontFamily: "JetBrains Mono" }} />
              <Tooltip contentStyle={TOOLTIP_STYLE} />
              <Bar dataKey="threats" fill="#ef4444" opacity={0.8} name="Findings" />
        ...
        {/* Risk distribution */}
        <div className="glass-panel p-4">
          <div className="font-mono text-xs text-cyan-600 font-medium mb-4">Risk levels</div>
        ...
        {/* Sector threat table */}
        <div className="glass-panel p-4">
          <div className="font-mono text-xs text-cyan-600 font-medium mb-4">Summary by area</div>
