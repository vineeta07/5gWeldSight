  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="font-display font-bold text-2xl text-slate-900 tracking-wide">Weld zones</h1>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="xl:col-span-2 glass-panel overflow-hidden">
          <div className="flex items-center gap-2 px-3 py-2 border-b border-slate-200 flex-wrap">
            <span className="font-mono text-xs text-cyan-600 font-medium">Zones on</span>
          ...
          <div className="relative" style={{ paddingBottom: "56.25%", background: "#000" }}>
            ...
            <div className="absolute bottom-2 left-2 font-mono text-[9px] text-slate-700">Example zones (demo data)</div>
          </div>
        </div>
