...
export default function BorderMap() {
  ...
  return (
    <div className="p-4 space-y-4 h-full">
      <div>
        <h1 className="font-display font-bold text-2xl text-slate-900 tracking-wide">Facility map</h1>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-4">
        ...
        <div className="xl:col-span-3 glass-panel overflow-hidden" style={{ minHeight: 480 }}>
          <div className="flex items-center justify-between px-3 py-2 border-b border-slate-200">
            <span className="font-mono text-xs text-cyan-600">Example layout (demo data)</span>
          ...
          <div className="relative w-full rounded-b-lg" style={{ paddingBottom: "56%", background: "linear-gradient(180deg, #f8fafc 0%, #f1f5f9 60%, #e2e8f0 100%)" }}>
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
              ...
              <text x="5" y="7" fill="rgba(16,185,129,0.7)" fontSize="2.5" fontFamily="monospace">Facility boundary</text>

              {/* Sectors */}
              {[["Bay A", 10, 30], ["Bay B", 40, 35], ["Bay C", 65, 45], ["Yard", 20, 70], ["Lab", 75, 50]].map(([label, x, y]) => (
              ...
              <text x="28" y="34" fill="rgba(239,68,68,0.7)" fontSize="2" fontFamily="monospace" fontWeight="bold">Open findings</text>
