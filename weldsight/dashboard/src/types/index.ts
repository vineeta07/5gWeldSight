...
export type ObjectType =
  | "rust" | "crack" | "porosity" | "undercut" | "spatter" | "lack_of_fusion" | "burn_through"
  | "heat_anomaly" | "weld_defect" | "person" | "unknown";
export type UserRole = "ADMIN" | "COMMANDER" | "OPERATOR" | "ANALYST" | "INSPECTOR";
...
export interface Camera {
  ...
  location: string;
  rtsp_url?: string;
  stream_url?: string; // rtsp/http stream the backend reads and annotates
  video_source?: string; // a video file served by this dashboard
...
export interface Incident {
  ...
  created_at: string;
  source?: "camera" | "video" | "website" | string;
  coverage_pct?: number | null;
  evidence_hash?: string;
  image?: string | null; // data URL of the annotated frame
}
